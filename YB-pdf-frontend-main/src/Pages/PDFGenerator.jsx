              ...
              <View style={stylesProfile.contentContiner}>
                ...
                <view style={stylesProfile.contentContainer}>
                  ...
                  <View style={stylesProfile.rightContainer}>
                    <Text style={[stylesProfile.text, stylesProfile.nameText]}>
                      {profile.name}
                    </Text>
                    <Text
                    ...
                    <Text
                      style={[stylesProfile.text, stylesProfile.departmentText]}
                    >
                    ...
                    <Text
                      style={[stylesProfile.text, stylesProfile.join_yearText]}
                    >
